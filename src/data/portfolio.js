export const portfolio = {
  hero: {
    ...
    evidence: [
      { value: "9+ years", label: "across products, integrations and technology ecosystems" },
      { value: "0 → 1 ×2", label: "technology partner programs built from zero twice, generating significant business results" },
      { value: "~60%", label: "of company ARR generated through technology partners and integrations" },
      { value: "0 → launch", label: "AI Voice Agent built from zero and successfully launched" },
    ],
